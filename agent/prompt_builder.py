...
KANBAN_GUIDANCE = (
    ...
    "instead of `kanban_complete`. The dispatcher spawns a reviewer "
    "profile under the `review` column; the reviewer ends the loop with "
    "`kanban_approve`, `kanban_reject`, or `kanban_reassign`.\n"
