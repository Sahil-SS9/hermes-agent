...
def aggregate_moa_context(
    *,
    ...
    reference_outputs = _run_references_parallel(
        ...
        reference_timeout=reference_timeout,
        agent=agent,
        max_concurrency=reference_concurrency,
    )
...
class MoAChatCompletions:
    ...
    def create(self, **api_kwargs: Any) -> Any:
        ...
        # Maximum concurrent reference calls. None (default) = no limit
        # (all references fire at once). Set to 1 for sequential execution
        # — needed for local backends like LM Studio in JIT mode (#78011).
        reference_concurrency = preset.get("reference_concurrency")
