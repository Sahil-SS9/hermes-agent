...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("goal", "Set a standing goal Hermes works on across turns until achieved", "Session",
               args_hint="[text | draft <text> | route [text] | show | pause | resume | clear | status | wait <pid> | unwait]"),
...
#   - version: low-frequency info command; was silently clamped off the
#     50-cap (the exact failure mode this list exists to prevent) rather
#     than deliberately routed — now explicit, reached via /hermes version.
