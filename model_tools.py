...
def _compute_tool_definitions(
    ...
    try:
        ...
        # Skip progressive disclosure for unrestricted sessions
        # (enabled_toolsets is None): that branch already included every
        # toolset by design, so deferring non-core plugin tools behind
        # tool_search would drop registered tools the model expects to see
        # directly (regression: test_unrestricted_session_unaffected).
