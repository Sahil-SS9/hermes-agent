...
LAYER_B_OK="no"
grep -q "DEFAULT_RESULT_SIZE_CHARS: int = 25_000" /home/kensei/.hermes/hermes-agent/tools/budget_config.py 2>/dev/null && LAYER_B_OK="yes"
...
SHIM_OK="no"
[[ "$SHIM_TARGET" == "/home/kensei/.hermes/hermes-agent/venv/bin/hermes" ]] && SHIM_OK="yes"
