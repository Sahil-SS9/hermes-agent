...
Runs as a no_agent=True cron. Output delivered verbatim to Telegram.
Silent when nothing to report.

Uses absolute paths (not ~) because cron HOME can vary by profile.
"""
...
ESCALATION_AGE = 3600  # 60 minutes
now = int(time.time())
lines = []
total_blocked = 0
